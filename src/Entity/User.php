 ...
 *       },
 *      "get"={
 *          "openapi_context"={"security"={{"bearerAuth"={}}}, "summary"="List of all users", "description"="List of all users. (owner customer and admin only)<br/> Max users per page: 30"},
 ...
 *       },
 *      "post"= {
 *         "openapi_context"={"security"={{"bearerAuth"={}}}, "summary"="Create a new user resource", "description"="Create a new user resource (owner customer and admin only)"},
 ...
 *  itemOperations={
 *      "get"= {
 *         "openapi_context"={"security"={{"bearerAuth"={}}}, "summary"="Get a user resource", "description"="Get a user resource (owner user, owner customer and admin only)"},
 *         "security"="is_granted('USER_VIEW', object)",
 *         "security_message"="Restricted to owner customer or admins",
 *       },
 *      "delete"= {
 *         "openapi_context"={"security"={{"bearerAuth"={}}}, "summary"="Delete a user resource", "description"="Delete a user resource (owner customer and admin only)"},
 *         "security"="is_granted('ROLE_ADMIN', object)",
 *         "security_message"="Restricted to owner customer or admins",
 *       },
 *      "patch"= {
 *         "openapi_context"={"security"={{"bearerAuth"={}}}, "summary"="Update a user resource", "description"="Update a user resource (owner user, owner customer and admin only)"},
