 ...
 *      "get" ={
 *         "openapi_context"={"security"={{"bearerAuth"={}}}, "summary"="List of all product categories", "description"="List of all product categories. (only authenticated users can access this resource)<br/> Max categories per page: 30"},
 ...
 *             "summary"="Admin - Create a new product category resource ", "description"="Create a new product category resource  (admin only)",
 *          },
 ...
 *          "openapi_context"={"security"={{"bearerAuth"={}}}, "summary"="Get a product category resource ", "description"="Get a product category resource  (only authenticated users can access this resource)"},
 *          "security"="is_granted('IS_AUTHENTICATED_FULLY')",
 *          "security_message"="You must be logged in to access this resource",
 *       },
 *      "patch"= {
 *         "denormalization_context"={"groups"={"create:type"}},
 *         "openapi_context"={"security"={{"bearerAuth"={}}}, "summary"="Admin - Update a product category resource ", "description"="Update a product category resource  (admin only)"},
 *         "security"="is_granted('ROLE_ADMIN')",
 *         "security_message"="Only admins can edit types",
 *       },
 *      "delete" = {
 *          "openapi_context"={"security"={{"bearerAuth"={}}}, "summary"="Admin - Delete a product category resource ", "description"="Delete a product category resource  (admin only)"},
 *          "security"="is_granted('ROLE_ADMIN')",
